 ...
 */
export function createEmptyScript(): ElizaScript {
  return {
    keywords: new Map(),
    synonyms: new Map(),
    preSubstitutions: [],
 ...
 */
export function parseScript(scriptText: string): ElizaScript {
 ...
 */
function parseLine(line: string, script: ElizaScript, state: ParserState): void {
