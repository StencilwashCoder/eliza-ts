/**
 * Default ELIZA Script - The Classic Psychotherapist
 *
 * This is the original ELIZA script that simulates a Rogerian psychotherapist.
 * It was designed by Joseph Weizenbaum to demonstrate that the appearance
 * of understanding can be achieved with simple pattern matching.
 *
 * The script is embedded here for zero-dependency usage.
 */
...
key: like 10
  decomp: * @be *like *
    reasmb: goto alike
`;
//# sourceMappingURL=defaultScript.js.map